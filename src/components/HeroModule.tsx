...
export default function HeroModule({ user }: HeroModuleProps) {
    return (
    <StarryContainer starCount={20} className="card relative isolate overflow-hidden px-6 lg:px-6 m-0">
      ...
      <div className="mx-auto max-w-2xl py-20 sm:py-28 lg:py-36">
        <div className="text-center">
          ...
          <p className="mt-8 text-lg font-medium text-pretty text-[#c5ddff]/90 sm:text-xl/8">Change the way you find and post auditions.</p>
