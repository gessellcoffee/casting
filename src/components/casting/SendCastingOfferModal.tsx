                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="neu-button-group-equal pt-4">
                      <button
                        ...
                        onClick={onClose}
                        disabled={isSubmitting}
                        className="px-4 py-2.5 rounded-lg border border-neu-border text-neu-text-primary hover:bg-neu-surface/50 transition-colors disabled:opacity-50"
                      >
                        Cancel
                      </button>
                      <button
                        ...
                        className="px-4 py-2.5 rounded-lg bg-green-600 hover:bg-green-700 text-white font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
