          ...
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
              ...
              <div className="flex items-center gap-3">
                <Link
                  href="/cast/new"
                  className="n-button-secondary flex items-center justify-center gap-2 whitespace-nowrap sm:flex-shrink-0"
                >
                  <span className="text-lg">+</span>
                  <span className="hidden sm:inline">Post an Audition</span>
